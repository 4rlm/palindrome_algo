...
Gem::Specification.new do |spec|
  spec.name          = "palindrome_algo"
  spec.version       = PalindromeAlgo::VERSION
  spec.authors       = ["Adam Booth"]
  spec.email         = ["4rlm@protonmail.ch"]

  spec.summary       = %q{Simple algorithm to find and return list of palindromes from your text input}
  spec.description   = %q{Simple algorithm to find and return list of palindromes from your text input.}

  spec.homepage      = 'https://github.com/4rlm/palindrome_algo'
  spec.license       = "MIT"
